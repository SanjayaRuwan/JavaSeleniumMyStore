...
public class BaseClass {
	...
	public void setup(String br){  
		...
		if(br.equals("chrome"))
		{
			System.setProperty("webdriver.chrome.driver",readCon.getchromPath());
			driver= new ChromeDriver();
		}
		else if(br.equals("firefox"))
		{
			System.setProperty("webdriver.gecko.driver", readCon.getFFPath());
		...
		logger = Logger.getLogger("My Store");
